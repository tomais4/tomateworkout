...
# --- DADOS PADRÃO (Para quando a memória estiver vazia) ---
TREINOS_PADRAO = {
    "A: EMPURRAR": [
...
def main(page: ft.Page):
        ...
        page.add(
            ft.Container(
                content=ft.Column([
                    ...
                    ft.Text("FDC MALUCO - STORE ON", color="green", weight="bold", size=14),
                    ...
                    ft.Text("V-PC Stable 2.0", color="#333", size=10)
    ...
    def executar(nome):
        ...
        def finalizar(e):
            ...
            # Solução Universal (Funciona em qualquer versão)
            page.snack_bar = ft.SnackBar(ft.Text("Treino Salvo e Finalizado!"), bgcolor="green")
